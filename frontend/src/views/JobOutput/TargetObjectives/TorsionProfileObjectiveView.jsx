...
class TorsionProfileObjectiveView extends React.Component {
  state = {
    targetData: null,
    objectiveData: {},
    currFrame: 0,
...
TorsionProfileObjectiveView.propTypes = {
...
export default withStyles(styles)(TorsionProfileObjectiveView);
