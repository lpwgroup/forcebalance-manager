...
class AbinitioSMINORFFOptions extends React.Component {
  state = {
    targetData: null,
    currFrame: 0,
    tabValue: 0,
    ...
    const optionsPage = targetOptions ? <div className={classes.tabContent} >
      <Grid container>
        ...
        <GridItem xs={3} sm={3} md={3}>
          ...
          <Chip key={targetOptions.mol2} label={targetOptions.mol2} />
        </GridItem>
        <GridItem xs={3} sm={3} md={3}>
          <Typography className={classes.dividerFullWidth} color="textSecondary" variant="caption">
            pdb
          </Typography>
          <Chip key={targetOptions.pdb} label={targetOptions.pdb} />
        </GridItem>
        <GridItem xs={12} sm={12} md={12}>
          <Divider className={classes.divider}/>
        </GridItem>
...
AbinitioSMINORFFOptions.propTypes = {
  classes: PropTypes.object.isRequired,
  targetName: PropTypes.string.isRequired,
  onClose: PropTypes.func,
};

export default withStyles(styles)(AbinitioSMINORFFOptions);
